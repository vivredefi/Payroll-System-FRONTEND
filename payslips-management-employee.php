...
$sql = "SELECT * FROM tblpayslips Where employee_id ='" . $_SESSION['username'] . "'";
    ...
    <div class="main-container d-flex">
        ...
        <div class="sidebar bg-light text-dark" id="side_nav">
            ...
            <ul class="list-unstyled px-2 text-dark bg-light mt-1">
                <li class="active"><a href="payslips-management-employee.php"
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <input type="hidden" name="generatetxtemployeeid" id="generatetxtemployeeid" readonly>
